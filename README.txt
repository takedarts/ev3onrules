...
EV3onRulesのライセンスはGPL2.0となります。 これは、EV3onRulesの一部のファイ
ルはToppers/EV3RT(beta6-3)のファイルを改変したものであるためです。

免責事項
--------

EV3onRulesの開発者及び配布者は、利用者がEV3onRulesを使用することによって生
じるいかなる損害に対しても一切責任を負いません。
